...
.. attention::
  ...
  The absolute paths for ``~/shared-clinfra-ns12127k**`` are actually ``/mnt/clinfra-ns12127k**``. A lot of python packages do not accept symbolic links, so please, use ``/mnt/**``.


- ``~/shared-clinfra-ns12127k-ns9034k-cmip6/`` NorESM KeyClim and ForCes data.
- ``~/shared-clinfra-ns12127k-ns9560k-datalake/CAM6_CESM_PPE`` CAM6 output for Perturbed Parameter Experiment

- ``~/shared-clinfra-ns12127k-ns9560k-datalake/ESGF/CMIP6`` subset of CMIP6 data from ESGF.

- ``~/shared-clinfra-ns12127k-ns9252k/escience2026/data`` contains  shared data requested by individual groups

- ``~/shared-clinfra-ns12127k/data/catalogs`` - various intake catalogs for local + pangeo data access.
...
.. note:: 
   :class: toggle
    ...
    .. - ``~/shared-clinfra-ns12127k-ns9560k-datalake/escience2024/data/data_group1/``:
    ...
    .. - ``~/shared-clinfra-ns12127k-ns9560k-datalake/escience2024/data/data_group3/**``:
    ...
    .. - ``~/shared-clinfra-ns12127k-ns9560k-datalake/escience2024/data/data_group4/`` Fire emissions from CAMS and MERRA2 + aerosol data from `<https://doi.org/10.5194/acp-24-2059-2024>`_ and `<https://doi.org/10.17043/zeppelin-ebc-2015-2019-1>`_.

    .. - ``~/shared-clinfra-ns12127k-ns9560k-datalake/escience2024/data/data_group6/`` Hysplit(2018-2019), AMS, CCN and cloud radar derived cloud base Updraft data (warm non-precipitating clouds) from Zeppelin (Ny-Ålesund).
 
    ..     - ``./CMIP6`` additional variables for historical, abrupt-4xCO2, 1pctCO2, ssp119, ssp585 with IPSL and HadGEM3.

    .. - ``~/shared-clinfra-ns12127k-ns9560k-datalake/escience2024/data/data_group7/``:
